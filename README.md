...
![DB Setup and Start](./animations/DB-Setup-&-Start.mp4)

![GET All](./animations/Get-All.mp4)

![GET All by ID](./animations/Get-By-ID.mp4)

![POST PUT DELETE Products and Tags](./animations/POST-PUT-DELETE-PRODUCTS-&-TAGS.mp4)

![POST PUT DELETE Categories](./animations/POST-PUT-DELETE.mp4)
